...
//check with values from past code
//also check with cubic box
...
void TestNmolecule2(){
    ...
    search_instr.iterations = 200;
    
    CrystalSearch twomolsearch(search_instr);
    twomolsearch.setDensity(0.24);
...
void TestNmolecule2R(){
    ...
    search_instr.setCombinations(combns);
    search_instr.iterations = 500;
    search_instr.populationCount=5000;
...
void TestNmolecule4R(){
    ...
    search_instr.setCombinations(combns);
    search_instr.iterations = 500;
    search_instr.populationCount=1000;
    
    CrystalSearch fourmolsearch(search_instr);
    fourmolsearch.setDensity(0.24);
